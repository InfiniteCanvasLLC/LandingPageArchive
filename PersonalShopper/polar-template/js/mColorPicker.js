...
(function($){
  ...
  $.fn.mColorPicker.events = function() {
    ...
    $('body').on('click', '.mColorPickerTrigger', $.fn.mColorPicker.colorShow);
  
    $('body').on('mousemove', '.mColor, .mPastColor', function(e) {
    ...
    }).on('click', '.mColor, .mPastColor', $.fn.mColorPicker.colorPicked);
  
    $('body').on('keyup', '#mColorPickerInput', function (e) {
    ...
    $('body').on('mouseleave', '#mColorPickerWrapper', function () {
